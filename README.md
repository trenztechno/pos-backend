...
A production-ready, offline-first billing system designed for restaurants, cafes, and retail stores in India. Features comprehensive GST billing support with HSN/SAC-based tax calculation, multi-device synchronization, server-controlled bill numbering, and a complete inventory management system.
...
- HSN/SAC based tax calculation - item-level HSN codes or vendor-level SAC codes
...
1. **[MOBILE_APP_GUIDE.md](MOBILE_APP_GUIDE.md)** - Complete integration guide with code examples
   ...
   - **HSN/SAC Tax Calculation:** How to use item-level HSN codes or vendor-level SAC codes for tax calculation
...
- **HSN/SAC Tax System:** [API_DOCUMENTATION.md](API_DOCUMENTATION.md#tax-calculation-hsnsac-based) - Item-level HSN codes or vendor-level SAC codes
...
- **SAC Code Setup:** [API_DOCUMENTATION.md](API_DOCUMENTATION.md#tax-calculation-hsnsac-based) - Set vendor-level SAC code for service-based businesses
...
- Includes HSN/GST fields (mrp_price, price_type, hsn_code, hsn_gst_percentage, veg_nonveg)
...
- `PATCH /auth/profile` - Update vendor profile
  ...
  - Set vendor-level SAC code and GST percentage for service-based businesses
...
- **HSN/SAC Tax System:** Item-level HSN codes for products, or vendor-level SAC codes for service businesses
- **Flexible Tax Calculation:** Each item can have different HSN codes and GST rates, or vendors can set SAC code for uniform rate
- **Server-Controlled Bill Numbering:** Automatic sequential bill number generation in format `{prefix}-{date}-{number}`
- **Automatic Tax Calculation:** Server calculates tax per item using HSN codes, or SAC code if vendor has one configured
...
- **HSN/SAC Tax Calculation:** Items use HSN codes for tax, or vendors can set SAC code to apply single rate to all items
